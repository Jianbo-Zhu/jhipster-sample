...
import net.jianbo.sample.config.audit.AuditEventConverter;
import net.jianbo.sample.domain.PersistentAuditEvent;
import net.jianbo.sample.repository.PersistenceAuditEventRepository;
import net.jianbo.sample.service.AuditEventService;
